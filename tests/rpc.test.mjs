...
export const tests = {
  ...
  "every rpc body in scripts/ parses": async () => {
    ...
    assert(per("sing/sing") === 17,
      `sing.js should have 17 bodies (upgrade, tor, progs, invites, join, read, gym, crime, faction, ` +
        `company, apply, travel, owned, faction augs, prereq, aug info, buy), found ${per("sing/sing")}`);
